...
/**
 * Forge 1.20.1 override for RemoveBlockAction.
 *
 * Differences from NeoForge:
 * - Uses Clearable.tryClear(blockEntity) instead of blockEntity.clearContent()
 *   for CopycatBlockEntity, which may not implement Clearable in Forge 1.20.1 Create
 */
