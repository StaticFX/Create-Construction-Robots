...
/**
 * Forge 1.20.1 override for ConstructionRenderer.
 *
 * Differences from NeoForge:
 * - Uses net.minecraftforge.client.event.RenderLevelStageEvent directly instead of NeoForge typealias
 *   (inner types like Stage don't resolve through typealiases)
 * - Uses net.minecraftforge.eventbus.api.SubscribeEvent instead of net.neoforged.bus.api.SubscribeEvent
 */
@ClientSide
