...
class StingerPlannerItem(properties: Properties) : Item(properties) {
    ...
    override fun appendHoverText(
        ...
        tooltip.add(Component.translatable("tooltip.cbbees.stinger_planner.line1")
            .withStyle(ChatFormatting.GRAY))
        tooltip.add(Component.translatable("tooltip.cbbees.stinger_planner.line2")
            .withStyle(ChatFormatting.GRAY))
        tooltip.add(Component.translatable("tooltip.cbbees.stinger_planner.line3")
