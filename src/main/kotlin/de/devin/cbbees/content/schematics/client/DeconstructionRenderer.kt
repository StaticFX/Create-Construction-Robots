...
object DeconstructionRenderer {
    ...
    fun renderHUD(guiGraphics: GuiGraphics, deltaTracker: DeltaTracker) {
        ...
        if (second != null) {
            ...
            val promptText = Component.translatable("cbbees.deconstruction.second_pos", AllKeys.START_ACTION.translatedKeyMessage)
    ...
    private fun renderStartButton(guiGraphics: GuiGraphics, mc: Minecraft, screenWidth: Int, screenHeight: Int) {
        ...
        val buttonText = Component.translatable("gui.cbbees.schematic.start_deconstruction", AllKeys.START_ACTION.translatedKeyMessage)
