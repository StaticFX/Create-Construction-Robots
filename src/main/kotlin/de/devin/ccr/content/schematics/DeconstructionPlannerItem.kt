...
class DeconstructionPlannerItem(properties: Properties) : Item(properties) {
    ...
    override fun appendHoverText(
        ...
        tooltip.add(Component.translatable("tooltip.ccr.deconstruction_planner.line1")
            .withStyle(ChatFormatting.GRAY))
        tooltip.add(Component.translatable("tooltip.ccr.deconstruction_planner.line2")
            .withStyle(ChatFormatting.GRAY))
        tooltip.add(Component.translatable("tooltip.ccr.deconstruction_planner.line3")
